...
public class ClickGui extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      if(latestVersion.isNewerThan(clientVersion)){
         ...
         mc.fontRenderer.drawString("Raven B+ v" + clientVersion + " | Config: " + Raven.configManager.getConfig().getName(), 4, this.height - 3 - mc.fontRenderer.FONT_HEIGHT, Utils.Client.astolfoColorsDraw(10, 14, speed));
      }
