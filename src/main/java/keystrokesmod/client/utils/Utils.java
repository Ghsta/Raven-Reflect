...
public class Utils {
   ...
   public static class Player {
      ...
      public static void sendMessageToSelf(String txt) {
         if (isPlayerInGame()) {
            ...
            Util.mc.player.sendMessage(new FakeChat.ChatMessage(m));
         }
      }
      ...
      public static boolean isPlayerHoldingWeapon() {
         if (mc.player.getHeldEquipment() == null) {
            return false;
         } else {
      ...
      public static void swing() {
         ...
         if (!p.isSwingInProgress  || p.swingProgressInt < 0) {
   ...
   public static class Client{
      ...
      public static void resetTimer() {
         try {
            getTimer().renderPartialTicks = 1.0F;
            ...
            if (type == 3) {
               ...
               if (type == 4) {
                  ...
                  if (type == 5) {
                     ...
                     if (type == 1) {
                        RenderGlobal.drawSelectionBoundingBox(axis,3,5,52,3);
                     } else if (type == 2) {
                        dbb(axis, r, g, b);
                     }
