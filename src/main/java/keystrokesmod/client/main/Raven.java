...
import keystrokesmod.ForgeEventListener;
...
public class Raven {
   ...
   public static void init() {
      JOptionPane.showMessageDialog(null,"https://github.com/Ghsta/Raven-Reflect");
      moduleManager = new ModuleManager();
      EVENT_BUS.register(new Raven());
      ...
      EVENT_BUS.register(new DebugInfoRenderer());
      EVENT_BUS.register(new MouseManager());
      EVENT_BUS.register(new ChatHelper());
      ex.execute(() -> {
         try {
