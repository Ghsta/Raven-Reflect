...
public class ModuleManager {
   ...
   public void sort() {
      if (HUD.alphabeticalSort.isToggled()) {
         ...
         modules.sort((o1, o2) -> Utils.mc.fontRenderer.getStringWidth(o2.getName()) - Utils.mc.fontRenderer.getStringWidth(o1.getName()));
      }
   ...
   public void sortLongShort() {
      modules.sort(Comparator.comparingInt(o2 -> Utils.mc.fontRenderer.getStringWidth(o2.getName())));
   }
