...
public class CFontRenderer extends CFont {
    ...
    int rainbowTickc = 0;
    Color rainbow = new Color(Color.HSBtoRGB((float) ((double) Minecraft.getMinecraft().player.ticksExisted / 50.0 - Math.sin((double) rainbowTickc / 40.0 * 1.4)) % 1.0f, 1.0f, 1.0f));
    ...
    public void getStringWidth(String s, float v, float v1, int i) {
    }

    public float drawStringWithShadow(String relife) {
        return 0;
    }
}
