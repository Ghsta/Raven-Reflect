...
import zen.relife.util.GlStateManager;
...
public class TTFFontRenderer {
    ...
    private int renderString(final String text, float x, float y, final int color, final boolean shadow) {
        if (text != "" && text.length() != 0) {
            GL11.glPushMatrix();
            zen.relife.util.GlStateManager.scale(0.5, 0.5, 1.0);
            zen.relife.util.GlStateManager.enableBlend();
            zen.relife.util.GlStateManager.blendFunc(770, 771);
            x -= 2.0f;
            y -= 2.0f;
            x += 0.5f;
            y += 0.5f;
            ...
            GL11.glPopMatrix();
            zen.relife.util.GlStateManager.disableBlend();
