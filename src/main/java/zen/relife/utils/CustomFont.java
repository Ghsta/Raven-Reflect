...
public class CustomFont {
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '§') {
                ...
                if (colorIndex < 16) {
                    ...
                    RenderUtil.color(colorCode[colorIndex]);
                } else {
                    switch (colorIndex) {
                        case 17:

                            if (hasBoldFont(new CustomFont(font))) {
                                bold = true;
                                if (italic) {
                        ...
                        case 20:
                            italic = true;
                            if (bold && hasBoldFont(new CustomFont(font))) {
                                GlStateManager.bindTexture(this.boldFont.italic.texture.getGlTextureId());
                                currentData = this.boldFont.italic;
                            } else {
    ...
    public boolean hasBoldFont(CustomFont customFont) {
