...
import zen.relife.eventbus.EventStoppable;
import zen.relife.eventbus.EventTarget;
import zen.relife.util.Priority;
...
public final class EventManager { //管理event
    ...
    public static void register(Object object, Class<? extends Event> eventClass) { //注册激活类
        for (Method method : object.getClass().getDeclaredMethods()) {
    ...
    public static void unregister(Object object) { //取消注册类
