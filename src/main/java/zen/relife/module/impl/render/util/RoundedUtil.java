package zen.relife.module.impl.render.util;

import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.ScaledResolution;
import zen.relife.util.RenderUtil;
import zen.relife.utils.GLUtil;
...
public class RoundedUtil {
    ...
    private static final zen.relife.module.impl.render.util.ShaderUtil roundedTexturedShader = new zen.relife.module.impl.render.util.ShaderUtil("roundRectTexture");
    private static final zen.relife.module.impl.render.util.ShaderUtil roundedGradientShader = new zen.relife.module.impl.render.util.ShaderUtil("roundedRectGradient");
    public static zen.relife.module.impl.render.util.ShaderUtil roundedShader = new zen.relife.module.impl.render.util.ShaderUtil("roundedRect");
    public static zen.relife.module.impl.render.util.ShaderUtil roundedOutlineShader = new zen.relife.module.impl.render.util.ShaderUtil("roundRectOutline");
