...
import zen.relife.util.Color.ColorUtils;
...
public class ESP extends Module {
    ...
    private final EnableSetting Inv = new EnableSetting("Invisible", false);
    ...
    public void onRender(RenderWorldLastEvent event) {
        ...
        Iterator var3 = ESP.mc.world.loadedEntityList.iterator();
        while (var3.hasNext()) {
            Entity en = (Entity) var3.next();
            if (en == ESP.mc.player || en.isDead || !this.Inv.getEnable() && en.isInvisible() || ESP.bot(en)) continue;
