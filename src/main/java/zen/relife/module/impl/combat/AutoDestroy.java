...
public class AutoDestroy extends Module {
    ...
    private final IntegerSetting Delay = new IntegerSetting("Delay", 600, 0, 900, 1);
    private final EnableSetting SwapBack = new EnableSetting("SwapBack", false);
    private int oldcurrentitem;

    public AutoDestroy() {
        super("AutoShieldDestroy", Keyboard.KEY_NONE, Category.COMBAT, false);
